...
document.writeln(`
  <div class="image-row">
    <img src="./Assets/bg-img-1.png" alt="Kids Smiling" class="kids-img">
    <img src="./Assets/bg-2.png" alt="Kids Studying" class="kids-img">
    <img src="./Assets/bg-3.png" class="kids-img kid-hide" alt="Kid 3">
  </div>
`);
  ...
  document.writeln(`
    <h1 class="heading">
      ...
      <span>L</span><span>E</span><span>A</span><span>R</span><span>N</span><span>E</span><span>R</span><span>S</span>
    </h1>
  `);
  document.writeln(`<h2 class="heading-2">Table of ${tableNumber}</h2>`);

  document.writeln(`<div class="table-card">`);
  document.writeln(`<div class="table-body">`);
  for (let i = 1; i <= tableLength; i++) {
    document.writeln(`<div class="table-line"> ${tableNumber} x ${i} = ${tableNumber * i} </div>`);
  }
  ...
  `);
  document.writeln(`<h2 class="heading-forward-2">Forward Counting from ${startNum} - ${endNum}</h2>`);
  ...
  `);
  document.writeln(`<h2 class="heading-backward-2">Backward Counting from ${startNum} - ${endNum}</h2>`);
  for (let i = startNum; i >= endNum; i--) {
