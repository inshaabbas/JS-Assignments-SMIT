...
document.writeln(`Element at index 0 is ${fruits[1]} <br>`)
document.writeln(`Element at index 0 is ${fruits[2]} <br>`)
document.writeln(`Element at index 0 is ${fruits[3]} <br>`)
document.writeln(`Element at index 0 is ${fruits[4]} <br>`)