...
// var buyer = prompt(`Welcome to the Continental Bakery. What do you want to order Sir/Ma'am?`);

// var found = false;

// for(i=0; i < bakeryItems.length; i++){
//     if(bakeryItems[i] === buyer){
//         found = true;
//         document.writeln(`${buyer} is <b>available</b> at index ${i} in our bakery`)
//         break;
//     }
// }

// if(!found){
//     document.writeln(`We are Sorry. ${buyer} is <b>not available</b> in our bakery`)
// }

Q8. Write a program to identify the largest number in thegiven array.
A = [24, 53, 78, 91, 12].